...
# callbacks = [
#     CSVLogger(
#         f'MobileNet-2-layer-04-dropout_results.csv', separator=',', append=True
#     ),
#     EarlyStopping(monitor='val_loss', patience=30, mode='min', min_delta=0.0001),
#     ModelCheckpoint('./trained_models/MobileNet-2-layer-04-dropout', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
# ]
...
# model = load_model("./trained_models/MobileNet-2-layer-04-dropout")
...
# callbacks = [
#     CSVLogger(
#         f'MobileNet-2-layer-04-dropout-finetuned_results.csv', separator=',', append=True
#     ),
#     EarlyStopping(monitor='val_loss', patience=30, mode='min', min_delta=0.0001),
#     ModelCheckpoint('./trained_models/MobileNet-2-layer-04-dropout-finetuned', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
# ]
...
model = load_model("./trained_models/MobileNet-2-layer-04-dropout-finetuned")
...
import json
with open(f'MobileNet-2-layer-04-dropout_val_results.json', 'w') as f:
...
import json
with open(f'MobileNet-2-layer-04-dropout_test_results.json', 'w') as f:
