...
val_data = model.evaluate(gen_valid, steps=valididx/batch_size, return_dict=True)
print(val_data)

print("Writing validation results to file")
with open(f"{args.model_name}_val_results.json", "w") as f:
